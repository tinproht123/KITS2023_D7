  ...
  return (
    <Box sx={{ width: '100%',
      ...
      <TabContext value={value}>
        ...
        <TabPanel value='one'>
          <Typography variant="body1" gutterBottom sx={{ marginTop: '40px', marginBottom: '10px', fontSize: 22, fontWeight: 500 }}>
            Friends (0 of 0)
          </Typography>
        ...
        <TabPanel value='two'>
          ...
          <Button variant="contained" size="large" sx={{ transform: "translate(10px,5px)"  }}>Search</Button>
        </TabPanel>
      </TabContext>
    </Box>
  );
